...
client.py：运行在host os下，在终端输入'python client.py 192.168.243.129 1200', server IP 根据你的server来选择，端口为1200， 例如我的server IP为192.168.243.129，那么我的ip=192.168.243.129
